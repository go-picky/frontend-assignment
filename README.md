...
Email your final submissions to product@pickycorp.com

#### Primary Submission Method
Submit your solution as a public Git repository that includes:
- Full source code
- Documentation
- Configuration files
- Setup instructions
...
You may also submit your solution via:
- Private Git repository with access granted to reviewers:
  - daniel@pickycorp.com
  - shane@pickycorp.com
- Zip archive containing the complete project structure
- Any other organized format that maintains the project integrity

## Notes

The primary purpose of this assignment is to assess your technical skills and design choices. You have the freedom to choose your tools and approach, as long as the constraints above are met.
